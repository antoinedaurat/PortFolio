...
export const About = () => (
    <div className="columns is-centered section" id="about">
        <div className="column is-half has-text-justified">
            ...
            <p>
                I'm Antoine. Born and raised in Paris, I studied Music Composition in Berlin where I became
                <span className="has-text-weight-bold"> Machine Learning & Full Stack Web Developer </span>
                around 2018.
            </p>
            <br/>
